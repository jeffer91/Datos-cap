...
function run() {
  ...
  try {
    ...
    planStorage.upsertMany([{
      id: "plan-manual",
      archivo: { hash: "hash-anterior", ruta: "C:/anterior/plan.pdf" },
      docente: { codigo_documento: "UGPA-RGI2-07-PRO-251-2024-10", nombre: "Docente corregido" },
      diagnostico: { tipo_formacion: "Específica" },
      capacitaciones: [{ nombre: "Capacitación corregida" }],
      estado: "REVISAR",
      confianza: 88,
    ...
    planStorage.upsertMany([{
      id: "plan-ocr-nuevo",
      archivo: { hash: "hash-nuevo", ruta: "C:/nuevo/plan.pdf" },
      docente: { codigo_documento: "UGPA-RGI2-07-PRO-251-2024-10", nombre: "Texto OCR incorrecto" },
      diagnostico: {},
      capacitaciones: [],
      estado: "COMPLETO",
      confianza: 100,
    ...
    console.log("Persistencia de correcciones manuales: pruebas correctas.");
  } finally {
